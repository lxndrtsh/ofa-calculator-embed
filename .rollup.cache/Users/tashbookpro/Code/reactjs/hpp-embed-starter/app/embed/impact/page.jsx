      ...
      {showDev && (<div style={{
          ...
          <div style={{ marginBottom: '12px', paddingBottom: '12px', borderBottom: '1px solid #ddd' }}>
            ...
            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
              <button onClick={() => jumpToStep(1)} style={{
                padding: '4px 8px',
                fontSize: '10px',
              ...
              <button onClick={() => jumpToStep(2)} style={{
                padding: '4px 8px',
                fontSize: '10px',
                border: '1px solid #666',
              ...
              <button onClick={() => jumpToStep(3)} style={{
                padding: '4px 8px',
                fontSize: '10px',
                border: '1px solid #666',
            ...
            <button onClick={fillFakeData} style={{
                marginTop: '6px',
                padding: '4px 8px',
                fontSize: '10px',
                border: '1px solid #666',
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <label style={{ flex: 1 }}>
                ...
                <select value={form.county} onChange={e => setForm({ ...form, county: e.target.value })} disabled={!form.state} style={{
                padding: '12px',
          ...
          {submitted && cfg && (<>
              ...
              <div style={{ background: '#fff3cd', padding: 16, borderRadius: 8, marginTop: '24px' }}>
                <p style={{ margin: 0, fontSize: '14px' }}>
                  Your results have been submitted. Our team will contact you shortly to discuss your impact analysis.
                </p>
              </div>
            </>)}
        </div>)}
