...
export async function loadCountyData(apiBase) {
    if (countyDataCache) {
...
export async function getCountiesForState(state, apiBase) {
...
export async function getCountyRate(state, county, apiBase) {
...
export function convertRateToOpioidRxRate(ratePer100) {
    if (ratePer100 === null)
        return null;
    return ratePer100 / 100;
}
//# sourceMappingURL=countyData.js.map